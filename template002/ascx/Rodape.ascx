...
<div class="box_newsletter">
  <div class="container_rodape">
    <div class="texto_newslatter"><span>Quer receber nossas news?</span>Cadastre seu e-mail e receba nossas<br> promoções dicas e muitas novidades.</div>
  ...
  <div class="container_rodape">
      <div class="box_institucionais">
        ...
        <ul>
          ...
          <li class="lista_institucionais"><ciac:link id="lnkAfiliados" runat="server"></ciac:link></li>
      ...
      <div class="container_selos">
        <h5 class="title_rodape">Segurança</h5>
          ...
          <a href="javascript:OpenCertDetails()"><img src="imagens/selo_thawte.png" alt="Thawte"></a>
            <div class="rodape_ciashop">
             <h5 class="title_rodape">Desenvolvimento</h5> 
              <ciac:link id="selo_rodape_ciashop" runat="server"></ciac:link>
              <!--<componente name="ciac:link" id="selo_rodape_evision" />-->
            </div>
        </div>
      </div>
      ...
      <div class="box_fale_conosco">
       ...
       <div class="box-lojas">
        <h5 class="title_rodape">Lojas</h5>
         <ul class="lojas">
          <li><a href="../paginainstitucional/loja1">Campinas, SP - Av. Brasil</a></li>
          <li><a href="../paginainstitucional/loja2">Campinas, SP - Centro</a></li>
          <li><a href="../paginainstitucional/loja3">Campinas, SP - Shop. D. Pedro</a></li>        
          <li><a href="../paginainstitucional/loja4">Campinas, SP - Av. Amoreiras (Outlet)</a></li>            
         </ul>
         <ul class="lojas">
