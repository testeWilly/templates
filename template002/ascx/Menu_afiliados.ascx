<%@ Control Language="C#"  AutoEventWireup="true" CodeBehind="Topo.ascx.cs" Inherits="CiaShop.Loja.Assets.Templates._1.ascx.Topo" %><%@ Register Assembly="Ciashop.Privada.Componente" Namespace="Ciashop.Privada.Componente.Loja" TagPrefix="CiaC" %><div id="menu" class="menu nav-horizontal">
<span class="menu_conteudo">
    <ul>
        <li><ciac:link id="Menu_home" runat="server"></ciac:link></li>
        <li><ciac:link id="Menu_banners" runat="server"></ciac:link></li>
        <li><a href="#" class="nav-horizontal-link">Relatórios</a>
            <ul class="box_menu_topo_filhos nav-horizontalChildren">
                <li><ciac:link id="Menu_Vendas" runat="server"></ciac:link></li>
                <li><ciac:link id="Menu_visitas" runat="server"></ciac:link></li>
                <li><ciac:link id="Menu_vendas_por_comprador" runat="server"></ciac:link></li>
            </ul>
        </li>
        <li><ciac:link id="Menu_Email" runat="server"></ciac:link></li>
    </ul>
</span>
</div>
