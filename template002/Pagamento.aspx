...
<form id="form2" runat="server">
    ...
    <div id="containertopo">
            <div class="topo">
		<div class="topo_meio">
 			<div class="passos"><img src="imagens/passo_pagamento.png" alt="Pagamento"></div>
		</div>
  ...
  <div id="containerconteudo">
      ...
      <div id="conteudo">
        <div class="checkout_left"> 
            ...
            <div class="tit_box_checkout tit_close tit_checked"><h2>2. Entrega</h2></div>
            <div class="tit_box_checkout"><h2>3. Pagamento</h2></div>
          <div class="bg_pagamento">
          <ciac:carrinhobonus id="carrinhobonus" runat="server"></ciac:carrinhobonus>
          <ciac:paymentmethods id="PayMethods" runat="server"></ciac:paymentmethods>
           </div>
        </div>
