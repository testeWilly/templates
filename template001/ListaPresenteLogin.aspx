<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaPresenteLogin.aspx.cs" Inherits="CiaShop.Loja.Assets.Templates._1.ListaPresenteLogin" %>
...
<form id="form2" runat="server">
    ...
    <div id="container_bg">
        <div id="container">
            ...
            <!--Inicio Conteudo-->
            <div id="conteudo">
                <CiaC:ListaPresenteLogin id="ListaPresenteLogin1" runat="server"></ciac:ListaPresenteLogin>
            </div>
            <!--Fim Conteudo-->
        </div>
        <div id="rodape">
